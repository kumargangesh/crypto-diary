...
function CryptoFrontPage(props) {
  const deleteAllCrypto = async () => {
    if (
      ...
      props.Crypto_Price.length <= 0 &&
      props.Crypto_Quantity.length <= 0 &&
      props.Crypto_Amount_Invested.length <= 0
    ) {
        ...
        <ul className="dropdown-menu">
          <li>
            <Link className="dropdown-item" to="/newentry">
              <button className="btn  btn-outline-success">NEW CRYPTO</button>
            </Link>
          </li>

          <li>
            <Link className="dropdown-item" to="/showallcrypto">
              <button className="btn  btn-outline-success">ALL CRYPTOS</button>
            </Link>
          </li>

          <li>
            <Link className="dropdown-item" to="/showindividualcrypto">
